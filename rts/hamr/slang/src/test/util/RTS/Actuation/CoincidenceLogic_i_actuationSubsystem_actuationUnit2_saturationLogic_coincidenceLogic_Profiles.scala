...
@msig trait CoincidenceLogic_i_actuationSubsystem_actuationUnit2_saturationLogic_coincidenceLogic_Profile_Trait extends Profile

@record class CoincidenceLogic_i_actuationSubsystem_actuationUnit2_saturationLogic_coincidenceLogic_Profile (
  val name: String,
) extends CoincidenceLogic_i_actuationSubsystem_actuationUnit2_saturationLogic_coincidenceLogic_Profile_Trait {
...
@msig trait CoincidenceLogic_i_actuationSubsystem_actuationUnit2_saturationLogic_coincidenceLogic_Profile_P_Trait extends Profile {
...
@record class CoincidenceLogic_i_actuationSubsystem_actuationUnit2_saturationLogic_coincidenceLogic_Profile_P(
  ...
  ) extends CoincidenceLogic_i_actuationSubsystem_actuationUnit2_saturationLogic_coincidenceLogic_Profile_P_Trait {
...
@msig trait CoincidenceLogic_i_actuationSubsystem_actuationUnit2_saturationLogic_coincidenceLogic_Profile_PS_Trait extends Profile {
  def api_channel1: RandomLib // random lib for generating Base_Types.Boolean
  def api_channel2: RandomLib // random lib for generating Base_Types.Boolean
  def api_channel3: RandomLib // random lib for generating Base_Types.Boolean
  def api_channel4: RandomLib // random lib for generating Base_Types.Boolean
...
@record class CoincidenceLogic_i_actuationSubsystem_actuationUnit2_saturationLogic_coincidenceLogic_Profile_PS(
  ...
  var api_channel3: RandomLib, // random lib for generating Base_Types.Boolean
  var api_channel4: RandomLib // random lib for generating Base_Types.Boolean
  ) extends CoincidenceLogic_i_actuationSubsystem_actuationUnit2_saturationLogic_coincidenceLogic_Profile_PS_Trait {

  override def next: CoincidenceLogic_i_actuationSubsystem_actuationUnit2_saturationLogic_coincidenceLogic_PreState_Container_PS = {
    return (CoincidenceLogic_i_actuationSubsystem_actuationUnit2_saturationLogic_coincidenceLogic_PreState_Container_PS (
      api_channel1 = api_channel1.nextB(),
      api_channel2 = api_channel2.nextB(),
      api_channel3 = api_channel3.nextB(),
      api_channel4 = api_channel4.nextB()))
