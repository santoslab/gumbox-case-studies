...
@record class CoincidenceLogic_i_actuationSubsystem_actuationUnit2_saturationLogic_coincidenceLogic_GumboX_SlangCheck_TestRunner
  extends Random.Gen.TestRunner[CoincidenceLogic_i_actuationSubsystem_actuationUnit2_saturationLogic_coincidenceLogic_SlangCheckContainer]
  ...
  override def next(): CoincidenceLogic_i_actuationSubsystem_actuationUnit2_saturationLogic_coincidenceLogic_SlangCheckContainer = {
    ...
    return CoincidenceLogic_i_actuationSubsystem_actuationUnit2_saturationLogic_coincidenceLogic_SlangCheckContainer(
      api_channel1, api_channel2, api_channel3, api_channel4
    )
  }

  override def toCompactJson(o: CoincidenceLogic_i_actuationSubsystem_actuationUnit2_saturationLogic_coincidenceLogic_SlangCheckContainer): String = {
    return RTS.JSON.fromActuationCoincidenceLogic_i_actuationSubsystem_actuationUnit2_saturationLogic_coincidenceLogic_SlangCheckContainer(o, T)
  }

  override def fromJson(json: String): CoincidenceLogic_i_actuationSubsystem_actuationUnit2_saturationLogic_coincidenceLogic_SlangCheckContainer = {
    RTS.JSON.toActuationCoincidenceLogic_i_actuationSubsystem_actuationUnit2_saturationLogic_coincidenceLogic_SlangCheckContainer(json) match {
