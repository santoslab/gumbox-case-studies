...
@msig trait Actuator_i_actuationSubsystem_saturationActuatorUnit_saturationActuator_actuator_Profile_Trait extends Profile

@record class Actuator_i_actuationSubsystem_saturationActuatorUnit_saturationActuator_actuator_Profile (
  val name: String,
) extends Actuator_i_actuationSubsystem_saturationActuatorUnit_saturationActuator_actuator_Profile_Trait {
...
@record class Actuator_i_actuationSubsystem_saturationActuatorUnit_saturationActuator_actuator_Profile_P(
  ...
  ) extends Actuator_i_actuationSubsystem_saturationActuatorUnit_saturationActuator_actuator_Profile_P_Trait {
...
@msig trait Actuator_i_actuationSubsystem_saturationActuatorUnit_saturationActuator_actuator_Profile_PS_Trait extends Profile {
  def api_input: RandomLib // random lib for generating Base_Types.Boolean
  def api_manualActuatorInput: RandomLib // random lib for generating Base_Types.Boolean
}
...
@record class Actuator_i_actuationSubsystem_saturationActuatorUnit_saturationActuator_actuator_Profile_PS(
  ...
  var api_input: RandomLib, // random lib for generating Base_Types.Boolean
  var api_manualActuatorInput: RandomLib // random lib for generating Base_Types.Boolean
  ) extends Actuator_i_actuationSubsystem_saturationActuatorUnit_saturationActuator_actuator_Profile_PS_Trait {

  override def next: Actuator_i_actuationSubsystem_saturationActuatorUnit_saturationActuator_actuator_PreState_Container_PS = {
