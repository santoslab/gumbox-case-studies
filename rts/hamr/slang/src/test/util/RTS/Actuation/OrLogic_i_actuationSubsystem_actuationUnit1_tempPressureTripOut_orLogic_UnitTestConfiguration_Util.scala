...
object OrLogic_i_actuationSubsystem_actuationUnit1_tempPressureTripOut_orLogic_UnitTestConfiguration_Util {
  ...
  type DefaultComputeProfile = OrLogic_i_actuationSubsystem_actuationUnit1_tempPressureTripOut_orLogic_Profile_P
    ...
    return (OrLogic_i_actuationSubsystem_actuationUnit1_tempPressureTripOut_orLogic_Compute_UnitTestConfiguration (
      ...
      genReplay = (c: Container, testName: String, r: GumboXResult.Type) => Some(
       st"""Replay Unit Test:
            ...
            |    val testVector = RTS.JSON.toActuationOrLogic_i_actuationSubsystem_actuationUnit1_tempPressureTripOut_orLogic_PreState_Container_P(json).left
