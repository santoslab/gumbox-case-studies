...
object Manage_Heat_Source_impl_thermostat_regulate_temperature_manage_heat_source_GumboX_TestHarness_ScalaTest_Generator {
  ...
  def serializeReport(dir: Os.Path): Unit = {
    val filename = dir / s"Manage_Heat_Source_impl_thermostat_regulate_temperature_manage_heat_source_GumboX_TestHarness_ScalaTest_Generator_${System.currentTimeMillis()}.json"
...
import Manage_Heat_Source_impl_thermostat_regulate_temperature_manage_heat_source_GumboX_TestHarness_ScalaTest_Generator._

trait Manage_Heat_Source_impl_thermostat_regulate_temperature_manage_heat_source_GumboX_TestHarness_ScalaTest_Generator extends Manage_Heat_Source_impl_thermostat_regulate_temperature_manage_heat_source_GumboX_TestHarness_ScalaTest
  ...
  def next(profile: Manage_Heat_Source_impl_thermostat_regulate_temperature_manage_heat_source_Profile_P): Option[Manage_Heat_Source_impl_thermostat_regulate_temperature_manage_heat_source_PreState_Container_P] = {
    try {
      ...
      val api_lower_desired_temp = profile.api_lower_desired_temp.nextIsolette_Data_ModelTemp_impl()
      val api_regulator_mode = profile.api_regulator_mode.nextIsolette_Data_ModelRegulator_ModeType()
      val api_upper_desired_temp = profile.api_upper_desired_temp.nextIsolette_Data_ModelTemp_impl()

      return Some(Manage_Heat_Source_impl_thermostat_regulate_temperature_manage_heat_source_PreState_Container_P(api_current_tempWstatus,api_lower_desired_temp,api_regulator_mode,api_upper_desired_temp))
    } catch {
  ...
  def nextwL(profile: Manage_Heat_Source_impl_thermostat_regulate_temperature_manage_heat_source_Profile_PS): Option[Manage_Heat_Source_impl_thermostat_regulate_temperature_manage_heat_source_PreState_Container_PS] = {
    try {
      ...
      return Some(Manage_Heat_Source_impl_thermostat_regulate_temperature_manage_heat_source_PreState_Container_PS(In_lastCmd,api_current_tempWstatus,api_lower_desired_temp,api_regulator_mode,api_upper_desired_temp))
    } catch {
      case e: AssertionError =>
       // SlangCheck was unable to satisfy a datatype's filter
       return None()
  ...
  def testComputeCB_Profile_P(profile: Manage_Heat_Source_impl_thermostat_regulate_temperature_manage_heat_source_Profile_P): Unit = {
    for (i <- 0 until profile.numTests) {
        ...
        while (j < profile.numTestVectorGenRetries && retry) {
          next(profile) match {
            case Some(o) =>
              ...
              val json = isolette.JSON.fromRegulateManage_Heat_Source_impl_thermostat_regulate_temperature_manage_heat_source_PreState_Container_P(o, T)
  ...
  def testComputeCBwL_Profile_PS(profile: Manage_Heat_Source_impl_thermostat_regulate_temperature_manage_heat_source_Profile_PS): Unit = {
    for (i <- 0 until profile.numTests) {
        ...
        while (j < profile.numTestVectorGenRetries && retry) {
          nextwL(profile) match {
            case Some(o) =>
              ...
              val json = isolette.JSON.fromRegulateManage_Heat_Source_impl_thermostat_regulate_temperature_manage_heat_source_PreState_Container_PS(o, T)
