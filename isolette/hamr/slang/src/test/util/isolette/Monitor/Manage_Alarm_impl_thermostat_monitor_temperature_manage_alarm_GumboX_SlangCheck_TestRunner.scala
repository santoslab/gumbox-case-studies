...
@record class Manage_Alarm_impl_thermostat_monitor_temperature_manage_alarm_GumboX_SlangCheck_TestRunner
  extends Random.Gen.TestRunner[Manage_Alarm_impl_thermostat_monitor_temperature_manage_alarm_SlangCheckContainer]
  ...
  override def next(): Manage_Alarm_impl_thermostat_monitor_temperature_manage_alarm_SlangCheckContainer = {
    ...
    return Manage_Alarm_impl_thermostat_monitor_temperature_manage_alarm_SlangCheckContainer(
      api_current_tempWstatus, api_lower_alarm_temp, api_monitor_mode, api_upper_alarm_temp
    )
  }

  override def toCompactJson(o: Manage_Alarm_impl_thermostat_monitor_temperature_manage_alarm_SlangCheckContainer): String = {
    return isolette.JSON.fromMonitorManage_Alarm_impl_thermostat_monitor_temperature_manage_alarm_SlangCheckContainer(o, T)
  }

  override def fromJson(json: String): Manage_Alarm_impl_thermostat_monitor_temperature_manage_alarm_SlangCheckContainer = {
    isolette.JSON.toMonitorManage_Alarm_impl_thermostat_monitor_temperature_manage_alarm_SlangCheckContainer(json) match {
